    ...
    <>
      ...
      <div className='flex items-center justify-center min-h-screen dark:bg-slate-800'>
        <div className="flex flex-col w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl p-4 md:p-8">
          ...
          <button type='button' className='bg-[#D20939] rounded-xl p-4 mb-4 w-full'>
            <div className='flex flex-col items-left justify-center space-y-1'>
              ...
              <JoshepAlvarez textColor='text-white' breakOnMobile={true} />
