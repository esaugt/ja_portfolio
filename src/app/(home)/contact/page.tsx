            ...
            <div className="flex mt-32 justify-start">
                <div className="mx-auto w-full max-w-lg mt-16">
                    ...
                    <form action="https://api.web3forms.com/submit" className="mt-10">
                        ...
                        <button type="submit" className="mt-5 rounded-md px-10 py-2 text-white hover:text-gray-600 bg-slate-400 hover:bg-slate-300 transition-colors">Send Message</button>
                    </form>
                </div>
            </div>

            <div className="container flex flex-col items-center gap-4 mx-auto mt-16">
                <div className="grid w-full grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
                    <div className="flex flex-col items-center gap-3 px-8 py-10 rounded-3xl shadow-main">
                        ...
                        <p className="leading-7">Puedes escribirnos para mas detalles.</p>
                    ...
                    <div className="flex flex-col items-center gap-3 px-8 py-10 rounded-3xl shadow-main">
                        ...
                        <p className="leading-7">Reach out to us by phone</p>
                        <a className="text-lg font-bold text-purple-blue-500" href="tel:+516-486-5135">+593-486-5135</a>
                    </div>
                    <div className="flex flex-col items-center gap-3 px-8 py-10 rounded-3xl shadow-main">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38" fill="none">
                        ...
                        <p className="leading-7">Find us at our office</p>
