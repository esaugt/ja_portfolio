        ...
        <footer className="bg-white dark:bg-gray-900">
            <div className="container px-6 py-8 mx-auto">
                <div className="flex flex-col items-center text-center">
                    <a href="#">
                        <JoshepAlvarez size="text-2xl"/>
                    </a>

                    <p className="max-w-md mx-auto mt-4 text-gray-500 dark:text-gray-400">no dudes en contactarme.</p>
                    ...
                    <div className="flex flex-col mt-4 sm:flex-row sm:items-center sm:justify-center">
                        ...
                        <button className="w-full px-5 py-2 text-sm tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#5bff73f9] rounded-md sm:mx-2 sm:order-2 sm:w-auto hover:bg-[#b8ffc3f9] focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">Get started</button>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center sm:flex-row sm:justify-between">
                    <p className="text-sm text-gray-500">© Copyright 2025. Todos los Derechos Reservados.</p>
